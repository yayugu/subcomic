...
Route::group(['middleware' => 'auth'], function() {
    ...
    Route::get('/comic/{id}/preconvert', ['as' => 'comicPreConvert', 'uses' =>  'ComicController@preConvert']);
    ...
    Route::post('/user', ['as' => 'userStore', 'uses' =>  'UserController@store']);
    Route::get('/fav', ['as' => 'favorite', 'uses' => 'FavoriteController@index']);
    Route::post('/fav', ['as' => 'favorite', 'uses' => 'FavoriteController@store']);
    Route::post('/fav/delete', ['as' => 'favoriteDelete', 'uses' => 'FavoriteController@delete']);
});

Route::get('/login', ['as' => 'login', 'uses' => 'AuthController@loginForm']);
Route::post('/login', ['as' => 'loginPost', 'uses' => 'AuthController@login']);
